...
(leaf *hydra-work
  ...
  (hydra-work
   ...
   "
   Work.menu
  _d_:日記  _m_:毎日  _w_:若鮎  _t_:定例  _[__]_:創作  _h_ugo  _p_rint._r_e  _._term  i_e_dit  _c_ap./_u_p/d_n_
  _v_:合評  _f_:週秀  _s_:吟行  _k_:近詠  _y__,_:年度  _g_ist  _@_point^^  ___xsrv  _:_thunar  _b_ackup-all^^^^
"
