...
;;; ============================================================
;;;  Git Project Switcher (ivy-git-project)
;;;
;;;  How it works:
;;;    1. Searches each dir in `ivy-git-project-search-dirs' up to
;;;       `ivy-git-project-search-depth' levels deep, collecting .git entries.
;;;    2. Applies `ivy-git-project-alias-map': projects whose .git lives
;;;       outside Dropbox are replaced by their Dropbox counterpart to avoid
;;;       sync conflicts; the canonical path is excluded from the list.
...
;;         '("~/src/github.com/minorugh/" "~/Dropbox/GH/"
;;           "~/Dropbox/minorugh.com/"    "~/.env_source/"))
