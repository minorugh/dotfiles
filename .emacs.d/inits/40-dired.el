...
;; ============================================================
;;  Dired Key Bindings  (本体コマンド + 自作コマンドを1箇所に)
;; ============================================================
...
(with-eval-after-load 'dired
  ...
  (keymap-set dired-mode-map "a" #'dired-omit-mode)
  (keymap-set dired-mode-map "[" #'dired-hide-details-mode)
  ;; 自作コマンド
  (keymap-set dired-mode-map "<left>"  #'my-dired-up)
  (keymap-set dired-mode-map "<right>" #'my-dired-open)
  (keymap-set dired-mode-map "RET"     #'my-dired-open)
  (keymap-set dired-mode-map "s"       #'my-dired-sudo-rm)
  (keymap-set dired-mode-map "o"       #'my-dired-open-xdg)
  (keymap-set dired-mode-map "t"       #'my-open-tig)   ; my-tig-bridge.el
  (keymap-set dired-mode-map "]"       #'my-dired-gitk)
  (keymap-set dired-mode-map "p"       #'my-dired-permission-help)
  (keymap-set dired-mode-map "."       #'xsrv-deploy-dired)    ; see 40-remote.el
  (keymap-set dired-mode-map ","       #'xsrv-download-dired)  ; see 40-remote.el
  (keymap-set dired-mode-map "i"       #'my-sxiv))
...
;; ============================================================
;;  Dired Extensions
;;  omit / navigation / file-ops / external / help
;; ============================================================
