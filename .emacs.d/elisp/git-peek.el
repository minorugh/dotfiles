...
(defvar git-peek-commit-mode-map
  (let ((map (make-sparse-keymap)))
    (keymap-set map "<down>" #'git-peek--commit-next)
    (keymap-set map "SPC"    #'git-peek--commit-next)
    (keymap-set map "j"      #'git-peek--commit-next)
    (keymap-set map "<up>"   #'git-peek--commit-prev)
    (keymap-set map "b"      #'git-peek--commit-prev)
    (keymap-set map "k"      #'git-peek--commit-prev)
    (keymap-set map "RET"    #'git-peek--commit-go-preview)
    (keymap-set map "s"      #'git-peek--commit-save)
    (keymap-set map "C-g"    #'git-peek--commit-cancel)
    (keymap-set map "q"      #'git-peek--commit-cancel)
    (keymap-set map "?"      #'git-peek--show-help)
    map)
...
(defvar git-peek-preview-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (keymap-set map "RET" #'git-peek--preview-go-sidebar)
    (keymap-set map "f"   #'git-peek--preview-go-sidebar)
    (keymap-set map "s"   #'git-peek--preview-save)
    (keymap-set map "C-g" #'git-peek--commit-cancel)
    (keymap-set map "q"   #'git-peek--commit-cancel)
    (keymap-set map "?"   #'git-peek--show-help)
    map)
