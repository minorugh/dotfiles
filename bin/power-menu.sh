...
CHOICE=$( (
    ...
    echo "3. REBOOT"
    echo "4. RESTART MUTT"
    echo "5. BACKUP STOP  $BACKUP_STATUS"
    echo "6. BACKUP START $BACKUP_STATUS"
...
case "$CHOICE" in
    ...
    5.*) touch "$XSRV_STOP"; echo "xsrv-backup: stopped."; sleep 1; kill $PPID ;;
    6.*) rm -f "$XSRV_STOP"; echo "xsrv-backup: started."; sleep 1; kill $PPID ;;
